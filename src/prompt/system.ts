...
# Excel files
- Use \`readExcelMetadata\` tool to read file metadata: sheets names, rows and cols size.
- Use \`readExcelSheet\` tool to read sheet content in JSON, knowing its name.
